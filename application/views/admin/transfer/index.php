<div class="row">
    <div class="col-sm-12">
        <?php echo form_open_multipart('admin/transfer/createsave', array("id" => "transfer-form", "method" => "post","enctype" => "multipart/form-data")); ?>
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select id="police_station" name="police_station" class="form-control select2 station-cls" multiple>
                    ...
                    <div class="form-group col-md-12" style="height:100%">
                        ...
                        <select id="consignment_id" name="consignment_id[]" required multiple class="form-control select2 cons-cls" size="10">
...
function getAjaxConsignment(dist){
  ...
  console.log(station);
  $.ajax({
           url: '<?php echo base_url('admin/transfer/getConsignment'); ?>',
           type: "POST",
