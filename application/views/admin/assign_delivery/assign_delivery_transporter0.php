<link href="<?php echo base_url('asset/admin/'); ?>css/switch.css" rel="stylesheet" type="text/css"/>
<div class="row">
    <div class="col-sm-12">
    ...
    <div class="col-sm-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
              ...
              <input id="typeswitch" value="1" type="checkbox" onChange="assignBoxChng()">
              <span class="slider round"></span>
              </label>
              <span>
              <h4 id="titletype">Assign Transporter</h4></span>
              <br><br>
                    ...
                    <div class="table-wrap">
                        <div class="table-responsive">
                          ...
                          <div id="transferform" style="display:none;">
                            <form id="transfer-form" action="<?php echo base_url('admin/transfer/createsave_assign'); ?>" method="post">
                            <div class="form-group col-md-3" style="height:100%">
                                <label class="control-label mb-10 text-left">Consignment ID's<span class="help"></span></label>
                                <!-- <select id="consignment_idd" name="consignment_idd[]" required multiple class="form-control select2 cons-cls" size="10">
                                </select> -->
                                <input type="text" id="consignment_idd" required name="consignment_idd"  class="form-control" value="">
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label mb-10 text-left">Office<span class="help"></span></label>
                                <select id="selec_branch" name="selec_branch" required class="form-control select2" >
                                    <option value="">Select Office</option>
                                    <?php foreach ($branch as $k => $v) { ?>
                     ...
                     <div class="form-group col-md-3">
                       ...
                       <button type="submit" class="btn btn-info btn-rounded">Transfer</button>
                     </div>
                       <?php echo form_close(); ?>
                          </div>
                                      ...
                                      if($v->status != "inactive"){
                                        ...
                                        <tr data-id="<?php echo $v->id ?>">
                                          ...
                                          <td><?php $dt = new DateTime($v->timestamp);echo $dt->format('d, M Y h:i a'); ?></td>
                                            ...
                                            <?php if($v->new_deliverydate != ""){?>
                                            <td><?php  if($v->new_deliverydate != "1970-01-01"){$dt = new DateTime($v->new_deliverydate);echo $dt->format('d, M Y'); }?></td>
                                          <?php }else{ ?>
                                            <td></td>
                                            <?php
                                          }
