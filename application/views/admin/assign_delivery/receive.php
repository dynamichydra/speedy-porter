...
<div class="row">
    <div class="col-sm-12">
        <?php echo form_open_multipart('admin/assign_deliveryperson/receive', array("id" => "financialreport-form", "method" => "post","enctype" => "multipart/form-data")); ?>
                           ...
                           ?>
                                      ...
                                      // if($v->delivery_status == "in-transit" || $v->delivery_status == "pending" ){
                                        ...
                                        <tr data-id="<?php echo $v['id'];?>">
                                          ...
                                          <?php $merch_info = $this->assign_deliveryperson_model->get_where_all('customer', ['id' => $v['customer']]); ?>
                                            ...
                                            <?php if($v['receive_status'] == 'not_assigned'){ $trans = "Not Assigned";}else{$trans_check = $this->assign_deliveryperson_model->get_transporter($v['id']); $trans = $trans_check[0]['transporter']; $edit_id = $trans_check[0]['editid'];} ?>
                              ...
                              if(isset($_SESSION['user_type']) && $_SESSION['user_type'] != 'staff'){
                               ...
                               ?>
                                          ...
                                          <a href="<?php echo base_url('admin/assign_deliveryperson/retrieve_cons')."/".$v['id']; ?>" class="btn btn-default btn-icon-anim btn-square list-button" title="Cancel" onclick="return confirm('Are you sure you would like to retrieve this order?');"><i style="margin-top: 13px;" class="fa fa-undo"></i></a>
                                          <?php
                                        }
                                        ?>
                                        <a href="<?php echo base_url('admin/report/print_layout')."/".$v['consignment_id']; ?>" class="btn btn-success btn-icon-anim btn-square list-button" title="Print" target="_blank"><i style="margin-top: 15px;" class="fa fa-print"></i></a></td>
                                            <?php
                                          }
                                        }
                                          ?>
