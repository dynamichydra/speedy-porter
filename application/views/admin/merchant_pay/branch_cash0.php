                    ...
                    <div class="table-wrap">
                        <div class="table-responsive">
                          ...
                          <form action="<?php echo base_url('admin/merchant_pay/createsave_branch')?>" method="post">
                            ...
                            <button style="float:right;" type="submit" class="btn btn-info btn-rounded">Recived</button>
                                <!-- <button type="button" class="btn btn-default  btn-rounded button-back">Cancel</button> -->
                            </div>
                            </form>
                                    ...
                                    foreach ($row as $k => $v) {
                                      if($v->delivery_status != "cancelled"){
                                        ...
                                        ?>
                                            ...
                                            <?php if($v->payment_status == 'due' && $v->deduction_amount>0){$paid= $v->deduction_amount;}else{ $paid= $v->grand_total - $v->less_paid_return;}?>
                                              <td><?php echo $paid ?></td>
