    ...
    <div class="col-sm-12">
      <h5 class="modal-title">Personal Information:-</h5>
        <div class="panel panel-default card-view">
                ...
                <div class="panel-body">
                  ...
                  <?php if ($this->session->flashdata('success')): ?>
                    ...
                    <?php if ($this->session->flashdata('error')): ?>
                      ...
                      <?php echo form_open_multipart('admin/customer/createsave_profile', array("id" => "creatcustomer-form", "method" => "post","enctype" => "multipart/form-data")); ?>
            ...
            <b><h5 class="modal-title">Payment Information:-</h5></b>
            <div class="panel panel-default card-view">
                ...
                <div class="form-group">
                  <div class="col-sm-6" style="margin-top: 5px;">
                    <label class="control-label mb-10 text-left" style="color:red;"> Default Payment Option<span class="help"></span></label>
                    <select id="default_pymnt" name="default_pymnt" class="form-control select2" >
                        <option value="">Select Default</option>
                        <option <?php if(!empty($row) && $row['default_pymnt'] == 'bank') { ?>selected <?php } ?>  value="bank">Bank</option>
                        <option <?php if(!empty($row) && $row['default_pymnt'] == 'mobile_banking') { ?>selected <?php } ?> value="mobile_banking">Mobile Banking</option>
                    </select>
                  </div>
                </div>
            ...
            <h7 class="modal-title">Bank Details:-</h7>
              <div class="panel panel-default card-view">
                  ...
                  <div class="form-group">
                    <div class="col-sm-6" style="margin-top: 5px;">
                      ...
                      <input type="text" id="bName" name="bName" value="<?php echo (isset($row)) ? $row["bank_name"] : ""; ?>" class="form-control" placeholder="Bank Name" autocomplete="off">
                    </div>
                    <div class="col-sm-6" style="margin-top: 5px;">
            ...
            <h7 class="modal-title">Mobile Banking Details:-</h7>
              <div class="panel panel-default card-view">
              ...
              <div class="panel panel-default card-view">
                  ...
                  <div class="panel-wrapper collapse in">
                    ...
                    <?php if(isset($_SESSION['user_type']) && $_SESSION['user_type'] != 'branch'){ ?>
                      <?php if(isset($row['office']) && $row['office'] == ''){ $visibility = '';}else{ $visibility = 'disabled';} ?>
                    <div class="col-sm-6" style="margin-top: 5px;">
                        <label class="control-label mb-10 text-left"> Pickup Office <b style="color:red;">*</b><span class="help"><small style="color:red;">Once selected Pick office cannot be changed, contact Merchant Care: 01401333000</small></span></label>
                        <select id="office" name="office" class="form-control select2" required <?php echo $visibility;?>>
                            <option value="">Select Office</option>
                            <?php foreach ($branch as $k => $v) { ?>
                            <option   value="<?php echo $v['id']; ?>" <?php echo ((isset($row['office']) && $v['id'] == $row['office'])?'selected':'');?>><?php echo $v['name']; ?></option>
                            <?php } ?>
                        </select>
                        <!-- <small style="color:red;">Once selected Pick office cannot be changed, contact Merchant Care: 01401333000</small> -->
                    </div>
                  ...
                  <?php }else{ ?>
                    <input type="hidden" id="office" name="office" value="<?php if(isset($_SESSION['branch']) && $_SESSION['branch'] != '') echo $_SESSION['branch']; ?>">
                  <?php } ?>
                    </div>
