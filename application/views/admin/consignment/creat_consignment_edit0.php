                ...
                <div class="form-group col-md-12">
                  ...
                  ?>
                    ...
                    <!-- <div class="form-group col-md-6">
                        ...
                        <input type="text" id="recipient_address_detail" required="" name="recipient_address_detail" placeholder="Receipient Details" class="form-control" value="<?php if(isset($shipingd)) {echo $shipingd[0]["recipient_name"].','.$shipingd[0]["recipient_number"].','.$shipingd[0]["recipient_address"].','.$shipingd[0]["recipient_city"]; } ?>">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                          <div class="col-sm-6" style="margin-top: 5px;" id="recipient_name_div">
                              ...
                              <input type="text" class="form-control" required=""  placeholder="Recipient Name" value="<?php echo (isset($shipingd)) ? $shipingd[0]["recipient_name"] : ""; ?>" id="recipient_name" name="recipient_name" autocomplete="off">
                          </div>
                          <div class="col-sm-6" style="margin-top: 5px;">
                              <label class="control-label mb-10 text-left">Recipient Number <b style="color:red;">*</b><span class="help"></span></label>
                              <input type="number" class="form-control recipient_number" data-tag="rcpnt_num" required="" placeholder="Recipient Number" value="<?php echo (isset($shipingd)) ? $shipingd[0]["recipient_number"] : ""; ?>" id="recipient_number"  name="recipient_number" autocomplete="off">
                              <input type="hidden" class="form-control"  required="" value="<?php echo (isset($shipingd)) ? $shipingd[0]["id"] : ""; ?>" id="recipient_data_id"  name="recipient_data_id" autocomplete="off">
                          ...
                          <div class="col-sm-6" style="margin-top: 5px;">
                              ...
                              <input type="text" id="recipient_address_shipping" required="" placeholder="street name/House no./road name etc." name="recipient_address_shipping" placeholder="recipient Address" class="form-control" autocomplete="off" value="<?php echo (isset($shipingd)) ? $shipingd[0]["recipient_address"] : ""; ?>">
                              <input type="hidden" id="recipient_address" required="" name="recipient_address" value="<?php echo (isset($shipingd)) ? $shipingd[0]["id"] : "0"; ?>">
                          </div>
                            <div class="col-sm-6" style="margin-top: 5px;" id="addshipping_dist">
                              ...
                              <select id="district" required name="district" class="form-control select2 district-cls" >
                                  ...
                                  <option value="<?php echo $v['id']; ?>" <?php if(!empty($shipingd) && $shipingd[0]['district'] == $v['id']) { ?>selected <?php } ?>><?php echo $v['district_name']; ?></option>
                                  <?php } ?>
                              </select>
                            </div>
                ...
                <div class="panel-body">
                  <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="hidden" id="package_name" name="package_name" value="<?php echo (isset($row)) ? $row["package_name"] : ""; ?>">
                    </div>
                    <div class="form-group col-md-4">
