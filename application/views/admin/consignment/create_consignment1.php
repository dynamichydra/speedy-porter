...
<div id="responsive-modal" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            ...
                            <!-- <div class="form-group"> -->
                              ...
                              <div class="col-sm-6" style="margin-top: 5px;">
                                  ...
                                  <input type="number" class="form-control recipient_number" data-tag="rcpnt_num" required="" placeholder="Recipient Number" value="" id="recipient_number"  name="recipient_number" autocomplete="off">
                            ...
                            <!-- </div> -->
                              ...
                              <div class="form-group text-center">
                                <div class="col-sm-12" style="margin-top: 50px;">
                                  ...
                                  <button id="shipping_create" type="submit" class="btn btn-info btn-rounded">Create</button>
                                  <button id="shipping_okay" style="display:none;" type="button" class="btn btn-default  btn-rounded" data-dismiss="modal">Okay</button>
                                </div>
                              </div>
                              <?php echo form_close(); ?>
													</div>
...
$(document).ready(function(){
    ...
    var recipientAddress = "<?php echo (isset($row))?$row['recipient_address']:"";  ?>"
    ...
    $(document).on('change', '.customer-cls', function (e) {
       console.log("abc");
        ...
        $(document).on('keyup', '#cash_collect', function (e) {
          ...
          console.log('cashtocollect'+cashtocollect+'parcelprice'+parcelprice);
               ...
               var extraweight = (total_weight-1);
                 ...
                 var exchargee=$('#excharge');
                   ...
                   if(chargearea == "urban"){
                     ...
                     var dccharge = parseInt(pdata[0].urban_dc);
                     ...
                     var dccharge = parseInt(pdata[0].sub_urban_dc);
                     ...
                     var dccharge = parseInt(pdata[0].metro_dc);
    ...
    $.ajax({
        ...
        if(res.success == "true"){
           ...
           // }
             ...
             console.log('dc charge'+dcchrg+'/finaldc'+finaldc);
             if(extrchrg > 0){
...
$(document).on('change', '#no_of_items', function (e) {
 var product_weight = parseFloat($('[name="product_weight"]').val());
 var items = parseInt($('[name="no_of_items"]').val());
 if(product_weight >0 && items >0){
 var total_weight = (product_weight * items);
        ...
        $( ".recipient_number" ).autocomplete({
         ...
         select: function (event, ui) {
           ...
           if(tag == 'rcpnt_num'){
             ...
             $('#recipient_address_detail').val(ui.item.label+","+ui.item.address);
             $('#shipping_okay').css('display','block');
             $('#shipping_create').css('display','none');
