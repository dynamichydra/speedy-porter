        ...
        <div class="panel panel-default card-view">
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    ...
                    <!-- <div id= "box2" class="form-group col-md-3">
                    ...
                    <!-- <div id="box3" class="form-group col-md-3">
                ...
                <div id = "delivery_deduction" style="display:none;">
                <div class="form-group col-md-6">
                  <input type="checkbox" id="deduction" name="deduction" value="yes">
