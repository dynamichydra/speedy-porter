   ...
   <form method="post" action="<?php base_url('admin/delivery_person');?>">
     <div class="input-group mb-15" style="width:300px;">
       <select id="selected_branch" name="selected_branch" class="form-control">
         <option value="all">All Official's</option>
...
?>
                <div class="pull-right">
                    <a class="btn  btn-primary" href="<?php echo base_url('admin/employee/create'); ?>">Add new Official</a>
                </div>
                <?php
              }
            }
                                    ...
                                    foreach ($row as $k => $v) {
                                        ...
                                        <tr data-id="<?php echo $v['id'];?>">
                                          ...
                                          <td><?php echo $v['name'] ?></td>
                                            ...
                                            <td><?php echo ucfirst($v['designation']) ?></td>
                               ...
                               ?>
                                            <td>
                                              <?php if(isset($_SESSION['user_type']) && $_SESSION['user_type'] != 'branch'){?>
                                                <button class="btn btn-default btn-icon-anim btn-square list-button" onclick="actionFunction()" data-tag="edit" data-url="<?php echo base_url("admin/employee/create/".$v['id']);?>"><i class="fa fa-pencil"></i></button>&nbsp;
                                              <button class="btn btn-info btn-icon-anim btn-square list-button" onclick="actionFunction()" data-title="OFFICIAL" data-tag="delete" data-url="<?php echo base_url("admin/employee/delete/".$v['id']);?>"><i class="fa fa-trash-o"></i></button>&nbsp;
                                              <?php
                                            }
                                            ?>
                                            <!-- <a href="<?php echo base_url('admin/employee/print_official')."/".$v['id']; ?>" class="btn btn-success btn-icon-anim btn-square list-button" title="Print" target="_blank"><i style="margin-top: 15px;" class="fa fa-print"></i></a></td> -->
                                            <?php
                                          }
                                        }
                                          ?>
