        ...
        <div class="panel panel-default card-view">
            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <?php echo form_open_multipart('admin/employee/createsave', array("id" => "creatdelivery_person-form", "method" => "post","enctype" => "multipart/form-data")); ?>
                    <div class="form-group" style="">
                      <div class="col-sm-6">
                        <label class="control-label mb-10 text-left">Official ID<span class="help"></span></label>
                        <input type="text" class="form-control" required=""  placeholder="Employee ID" value="<?php echo (isset($row)) ? $row["employee_id"] : ""; ?>" id="employee_id" name="employee_id" autocomplete="off">
                      </div>
                      <div class="col-sm-6">
                        <label class="control-label mb-10 text-left">Official Name<span class="help"></span></label>
                    ...
                    <div class="form-group">
                      <div class="col-sm-6" style="margin-top: 5px;">
                        ...
                        <input type="text" id="designation" required="" name="designation" class="form-control" placeholder="Designation" autocomplete="off" value="<?php echo (isset($row)) ? $row["designation"] : ""; ?>">
                      </div>
                      <div class="col-sm-6" style="margin-top: 5px;">
                        <label class="control-label mb-10 text-left"> Department <span class="help"></span></label>
                        <input type="text" id="department" required="" name="department" class="form-control" placeholder="Department" autocomplete="off" value="<?php echo (isset($row)) ? $row["department"] : ""; ?>">
                      </div>
                    </div>
