...
<div class="row">
    <div class="col-sm-12">
        <?php echo form_open_multipart('merchant/report/payout_collection', array("id" => "financialreport-form", "method" => "post","enctype" => "multipart/form-data")); ?>
                                       ...
                                       $x++;
                                        ...
                                        <tr>
                                          <td><?php echo $v['consignment_id'] ?></td>
                                            ...
                                            <?php if($v['payment_status'] == "due") {?>
                                            <td style="color:red;"><?php echo ucfirst($v['payment_status']) ?></td>
                                          <?php }else if($v['payment_status'] == "paid"){ ?>
                                            <td style="color:green;"><?php echo ucfirst($v['payment_status']) ?></td>
                                            <?php
                                          }else{
                                          ?>
                                          <td style="color:yellow;"><?php echo ucfirst($v['payment_status']); ?></td>
                                          <?php
                                        }
                                        ?>
