                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" style="">
                      <div class="col-sm-6">
                        ...
                        <input readonly style="color:black;" type="text" id="voucher_no" required="" name="voucher_no" value="<?php echo (isset($row)) ? $row["voucher_no"] : $vouchernumber; ?>" class="form-control" placeholder="Voucher Number" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6" style="margin-top: 5px;">
                        ...
                        <input type="number" id="amount" required="" name="amount" class="form-control" placeholder="Amount" autocomplete="off" value="<?php echo (isset($row)) ? $row["amount"] : ""; ?>">
                      </div>
                    </div>
