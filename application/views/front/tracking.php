                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mob-none">                        
                                <ol class="breadcrumb-menubar list-inline">
                                    <li><a href="<?php echo base_url(); ?>" class="gray-clr">Home</a></li>                                   
                    ...
                    <div class="theme-container container ">  
                        ...
                        <div class="row">
                            <div class="col-md-7 pad-30 wow fadeInLeft" data-wow-offset="50" data-wow-delay=".30s"> 
                                <img alt="" src="<?php echo base_url(); ?>asset/new/img/block/product-1.jpg" />
                            </div>
                        ...
                        <div class="progress-wrap">
                            ...
                            <div class="row progress-content upper-text">
                                <div class="col-md-3 col-xs-8 col-sm-2">
                                    ...
                                    <h2 class="title-1 no-margin">Mumbai</h2>
                                </div>
                                ...
                                <div class="col-md-4 col-xs-8 col-sm-4 text-center">
                                    ...
                                    <h2 class="title-1 no-margin">Kolkata</h2>
                                </div>
                                ...
                                <div class="col-md-2 col-xs-8 col-sm-2 text-right">
                                    ...
                                    <h2 class="title-1 no-margin">Hooghly</h2>
                                </div>
                            </div>
                        </div>
                    </div>
